...
namespace gordejchik {
  ...
  private:
    using BaseNode = detail::base_node_t;
  ...
  T& List< T >::front()
  {
    return *detail::nodeValue(static_cast< Node* >(fake_.next));
  }

  template< class T >
  const T& List< T >::front() const
  {
    return *detail::nodeValue(static_cast< const Node* >(fake_.next));
  }

  template< class T >
  T& List< T >::back()
  {
    return *detail::nodeValue(static_cast< Node* >(fake_.prev));
  }

  template< class T >
  const T& List< T >::back() const
  {
    return *detail::nodeValue(static_cast< const Node* >(fake_.prev));
  }
